...
outputPath = "D:/project/HR데이터/데이터/역량진단 데이터/역량진단_응답데이터/question_scale_metadata_with_23_rebuilt.xlsx";
...
mergedTable.Period = cellstr(mergedTable.Period);
mergedTable.QuestionID = cellstr(mergedTable.QuestionID);
mergedTable = sortrows(mergedTable, {'Period','QuestionID'});

writetable(mergedTable, outputPath, 'Sheet', 'QuestionScales');
fprintf('✓ 23년 하반기 문항 %d개를 포함한 새로운 메타데이터 저장 완료: %s\n', numel(uniqueIDs), outputPath);
