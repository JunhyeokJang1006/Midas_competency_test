...
%   - 상위 10%, 25%, 33%, 50%, 100%(전체) 그룹별 특성 비교
%
% 입력:
...
config.percentiles = [10, 25, 33, 50, 100];  % 분석할 백분위수
...
figure('Position', [100, 100, 900, 600], 'Name', '백분위수별 Pearson 상관계수 변화');
...
fprintf('  ✓ 그림 표시: Pearson 상관계수 변화\n');

% 그림 2: R² 변화
figure('Position', [150, 150, 900, 600], 'Name', '백분위수별 R² 변화');
